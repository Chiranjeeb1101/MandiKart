            ...
            setOrders(prev => {
              ...
              const merged: DetailedOrder[] = result.data.map((liveOrder: any) => {
                ...
                return {
                  ...
                  status: (prevOrder && prevOrder.status === 'CONFIRMED' ? 'CONFIRMED' : (liveOrder.status || 'PLACED')),
                  escrowStatus: (prevOrder && prevOrder.escrowStatus ? prevOrder.escrowStatus : (liveOrder.escrowStatus || 'HELD_IN_ESCROW')),
