...
export interface PlatformAnalyticsData {
  metrics: {
    ...
    fulfillmentPurityRate: number; // 98.8%
    avgDeliveryTimeMinutes: number; // 42 min
  };
...
export class AnalyticsService {
  ...
  static async getDashboardAnalytics(
    ...
    const gmvGrowthCurve: ChartDataPoint[] = [
    ...
    const cropVolumeBreakdown: ChartDataPoint[] = [
    ...
    const regionalPriceVolatility: ChartDataPoint[] = [
    ...
    const deliveryFulfillmentTrends: ChartDataPoint[] = [
