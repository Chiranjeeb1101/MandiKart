...
class WeatherService {
     ...
     */
    static async getAgriWeather(latitude = 18.5204, longitude = 73.8567) {
    ...
    static mapWeatherCodeToText(code) {
        if (code === 0)
            return 'Clear Sky';
        if (code <= 3)
    ...
    static generateAgriAdvisory(temp, humidity, precip, wind) {
        if (precip > 5 || wind > 25) {
            return {
                harvestRecommendation: 'DELAY',
                pestRisk: 'HIGH',
