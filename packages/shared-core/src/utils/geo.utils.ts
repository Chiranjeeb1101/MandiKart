 ...
 */
export function estimateEtaMinutes(distanceKm: number, averageSpeedKmH: number = 32): number {
 ...
 */
export function reverseGeocodeLocal(latitude: number, longitude: number): GeoAddress {
