...
negotiationsRouter.get('/:id', requireAuth, BuyerNegotiationsController.getNegotiation);
...
negotiationsRouter.post('/:id/messages', requireAuth, BuyerNegotiationsController.sendMessage);
negotiationsRouter.post('/:id/respond', requireAuth, requireIdempotency, BuyerNegotiationsController.respondToCounterOffer);
negotiationsRouter.post('/:id/accept', requireAuth, requireIdempotency, BuyerNegotiationsController.convertToOrder);
